...
use App\Models\VolleyballSchedule;
use Illuminate\Support\Facades\Auth;

use Inertia\Inertia;

class VolleyballScheduleController extends Controller
{
    public function index()
{
    ...
    return view('volleyball.match_scores', compact('leagues'));
