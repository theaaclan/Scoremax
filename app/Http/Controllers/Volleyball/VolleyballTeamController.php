...
{
    // Get the current user's Volleyball teams
    $teams = auth()->user()->volleyballTeams;
    ...
    return Inertia::render('Volleyball/VolleyballTeams', [
        'teams' => $teams,
    ...
    public function schedule()
    {
        ...
        $teams = VolleyballTeam::where('LeagueID', $activeLeague->LeagueID)->get();
    
        return Inertia::render('Volleyball/VolleyballSchedule', [
    ...
    {
        $teams = VolleyballTeam::with('players')->where('user_id', auth()->id())->get();
    ...
    {
        return VolleyballTeam::where('TeamID', $id)
