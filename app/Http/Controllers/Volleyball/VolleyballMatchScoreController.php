...
use App\Models\VolleyballMatchScore;
use App\Models\VolleyballMatchDetails;

class VolleyballMatchScoreController extends Controller
{
    public function index()
    {
        $matchScores = VolleyballMatchScore::all(); // Retrieve all match scores from the database
