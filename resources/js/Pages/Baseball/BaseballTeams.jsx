...
const BaseballTeams = ({
    ...
    const fetchMatchScores = () => {
        ...
        axios
            .get(`/baseball_match_score?league_id=${activeLeague.LeagueID}`)
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedTeam) {
            // Update Team
            axios
                .put(`/baseballteams/${selectedTeam.TeamID}`, data)
                .then((response) => {
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "Baseball_Teams.xlsx");
    };
    ...
    return (
        <AuthenticatedLayout>
            <div className="container my-4">
                <h1 className="text-center mb-4">Baseball Teams</h1>
