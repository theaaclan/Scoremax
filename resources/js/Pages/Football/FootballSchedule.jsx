...
const FootballSchedule = ({ initialTeams }) => {
    ...
    useEffect(() => {
        ...
        if (activeLeagueData) {
            ...
            const key = `footballSchedule_${leagueID}`;
    ...
    useEffect(() => {
        ...
        const storedSchedule = JSON.parse(
            localStorage.getItem("footballSchedule")
        );
        if (storedSchedule) {
            setSchedule(storedSchedule);
        }
    ...
    const handleShuffle = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const key = `footballSchedule_${activeLeague.LeagueID}`;
                localStorage.setItem(key, JSON.stringify(formattedSchedule));

                axios
                    .post("/footballschedule", {
    ...
    const handleClear = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                localStorage.removeItem("footballSchedule");
        ...
        <AuthenticatedLayout>
            <div className="container mx-auto mt-8">
                ...
                <div className="flex justify-center gap-4 mb-6">
                    ...
                    <a
                        href={route("footballteams.index")}
