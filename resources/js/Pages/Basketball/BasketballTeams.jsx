...
const BasketballTeams = ({ teams: initialTeams = [], auth }) => {
    ...
    const fetchMatchScores = () => {
        ...
        axios
            .get(`/basketball_match_score?league_id=${activeLeague.LeagueID}`)
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedTeam) {
            // Update Team
            axios
                .put(`/basketballteams/${selectedTeam.TeamID}`, data)
                .then((response) => {
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "Basketball_Teams.xlsx");
    };
    ...
    const handlePrintTeamsPDF = () => {
        const doc = new jsPDF();
        doc.setFontSize(18);
        doc.text("Basketball Teams", 14, 10);
    ...
    return (
        <AuthenticatedLayout>
            <div className="container my-4">
                <h1 className="text-center mb-4">Basketball Teams</h1>
