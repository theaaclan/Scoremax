...
const BasketballPlayers = ({ players: initialPlayers = [], teams, auth }) => {
    ...
    const handleDropdownChange = (criteria) => {
        ...
        if (resultPlayer) {
            ...
            const statValue =
                criteria === "highestTotal"
                    ? (resultPlayer.Points || 0) +
                      (resultPlayer.Assists || 0) +
                      (resultPlayer.Rebounds || 0) +
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedPlayer) {
            // Update Player
            axios
                .put(`/basketballplayers/${selectedPlayer.PlayerID}`, form)
                .then((response) => {
                    setPlayers((prev) =>
                        prev.map((player) =>
    ...
    const historyColumns = [
        ...
        { name: "Rebounds", selector: (row) => row.Rebounds, sortable: true },
        { name: "Blocks", selector: (row) => row.Blocks, sortable: true },
        { name: "Fouls", selector: (row) => row.Fouls, sortable: true },
        {
            name: "Date",
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "Basketball_Players.xlsx");
    };
    ...
    const columnsMatchDetails = [
        ...
        { title: "Rebounds", dataKey: "Rebounds" },
        { title: "Blocks", dataKey: "Blocks" },
        { title: "Fouls", dataKey: "Fouls" },
    ];
    ...
    const handlePrintPlayersPDF = () => {
        ...
        doc.setFontSize(18);
        doc.text("Basketball Players List", 14, 10); // Title
        ...
        doc.save("BasketballPlayers.pdf");
    };
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            >
                                                ...
                                                <option value="highestPoints">
                                                    Highest Points
                                                </option>
                                                <option value="highestAssists">
                                                    Highest Assists
                                                </option>
                                                <option value="highestRebounds">
                                                    Highest Rebounds
                                                </option>
