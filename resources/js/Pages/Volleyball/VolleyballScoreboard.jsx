...
const VolleyballScoreboard = () => {
    const { teams, volleyballPlayers } = usePage().props;
    ...
    const [sets, setSets] = useState({ A: 0, B: 0 }); // State for set scores
    ...
    const handleSetChange = (teamKey) => {
        ...
        setScores({ A: 0, B: 0 }); // Reset the scores
    };
    ...
    const clearState = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                localStorage.removeItem("volleyballScoreboardState");
...
export default VolleyballScoreboard;
