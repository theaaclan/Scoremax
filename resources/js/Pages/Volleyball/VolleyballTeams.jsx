...
const VolleyballTeams = ({
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedTeam) {
            // Update Team
            axios
                .put(`/volleyballteams/${selectedTeam.TeamID}`, data)
                .then((response) => {
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "Volleyball_Teams.xlsx");
    };
    ...
    const handlePrintTeamsPDF = () => {
        const doc = new jsPDF();
        doc.setFontSize(18);
        doc.text("Volleyball Teams", 14, 10);
    ...
    return (
        <AuthenticatedLayout>
            <div className="container my-4">
                <h1 className="text-center mb-4">Volleyball Teams</h1>
