...
const VolleyballSchedule = ({ initialTeams }) => {
    ...
    useEffect(() => {
        ...
        if (activeLeagueData) {
            ...
            const key = `volleyballSchedule_${leagueID}`;
    ...
    useEffect(() => {
        ...
        const storedSchedule = JSON.parse(
            localStorage.getItem("volleyballSchedule")
        );
        if (storedSchedule) {
            setSchedule(storedSchedule);
        }
    ...
    const handleShuffle = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const key = `volleyballSchedule_${activeLeague.LeagueID}`;
                localStorage.setItem(key, JSON.stringify(formattedSchedule));

                axios
                    .post("/volleyballschedule", {
        ...
        <AuthenticatedLayout>
            <div className="container mx-auto mt-8">
                ...
                <div className="flex justify-center gap-4 mb-6">
                    ...
                    <a
                        href={route("volleyballteams.index")}
