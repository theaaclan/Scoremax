...
const VolleyballPlayers = ({ players: initialPlayers = [], teams, auth }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedPlayer) {
            // Update Player
            axios
                .put(`/volleyballplayers/${selectedPlayer.PlayerID}`, form)
                .then((response) => {
                    setPlayers((prev) =>
                        prev.map((player) =>
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "Volleyball_Players.xlsx");
    };
    ...
    const handlePrintPlayersPDF = () => {
        ...
        doc.setFontSize(18);
        doc.text("Volleyball Players List", 14, 10); // Title
        ...
        doc.save("VolleyballPlayers.pdf");
    };
