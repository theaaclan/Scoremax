...
const VolleySchedule = ({ initialTeams }) => {
    ...
    useEffect(() => {
        ...
        if (activeLeagueData) {
            ...
            const key = `volleySchedule_${leagueID}`;
    ...
    useEffect(() => {
        ...
        const storedSchedule = JSON.parse(
            localStorage.getItem("volleySchedule")
        );
        if (storedSchedule) {
            setSchedule(storedSchedule);
        }
    ...
    const handleShuffle = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const key = `volleySchedule_${activeLeague.LeagueID}`;
    ...
    const handleClear = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                localStorage.removeItem("volleySchedule");
