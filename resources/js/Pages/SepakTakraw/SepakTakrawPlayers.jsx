...
const SepakTakrawPlayers = ({ players: initialPlayers = [], teams, auth }) => {
    ...
    const handleDropdownChange = (criteria) => {
        ...
        if (resultPlayer) {
            ...
            const statValue =
                criteria === "highestTotal"
                    ? (resultPlayer.Kills || 0) +
                      (resultPlayer.Aces || 0) +
                      (resultPlayer.Digs || 0) +
                      (resultPlayer.Blocks || 0)
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedPlayer) {
            // Update Player
            axios
                .put(`/sepaktakrawplayers/${selectedPlayer.PlayerID}`, form)
                .then((response) => {
                    setPlayers((prev) =>
                        prev.map((player) =>
    ...
    const historyColumns = [
        ...
        { name: "Kills", selector: (row) => row.Kills, sortable: true },
        { name: "Aces", selector: (row) => row.Aces, sortable: true },
        { name: "Digs", selector: (row) => row.Digs, sortable: true },
        { name: "Blocks", selector: (row) => row.Blocks, sortable: true },
        {
            name: "Service_Errors",
            selector: (row) => row.Service_Errors,
            sortable: true,
        },
        {
            name: "Date",
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "SepakTakraw_Players.xlsx");
    };
    ...
    const columnsMatchDetails = [
        ...
        { title: "Kills", dataKey: "Kills" },
        { title: "Aces", dataKey: "Aces" },
        { title: "Digs", dataKey: "Digs" },
        { title: "Blocks", dataKey: "Blocks" },
        { title: "Service_Errors", dataKey: "Service_Errors" },
    ];
    ...
    const handlePrintPlayersPDF = () => {
        ...
        doc.setFontSize(18);
        doc.text("SepakTakraw Players List", 14, 10); // Title
        ...
        doc.save("SepakTakrawPlayers.pdf");
    };
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            >
                                                ...
                                                <option value="highestKills">
                                                    Highest Points
                                                </option>
                                                <option value="highestAces">
                                                    Highest Aces
                                                </option>
                                                <option value="highestDigs">
                                                    Highest Digs
                                                </option>
                                                <option value="highestBlocks">
                                                    Highest Blocks
                                                </option>
...
export default SepakTakrawPlayers;
