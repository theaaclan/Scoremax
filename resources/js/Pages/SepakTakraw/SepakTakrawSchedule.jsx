...
const SepakTakrawSchedule = ({ initialTeams }) => {
    ...
    useEffect(() => {
        ...
        if (activeLeagueData) {
            ...
            const key = `sepaktakrawSchedule_${leagueID}`;
    ...
    useEffect(() => {
        ...
        const storedSchedule = JSON.parse(
            localStorage.getItem("sepaktakrawSchedule")
        );
        if (storedSchedule) {
            setSchedule(storedSchedule);
        }
    ...
    const handleShuffle = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const key = `sepaktakrawSchedule_${activeLeague.LeagueID}`;
                localStorage.setItem(key, JSON.stringify(formattedSchedule));

                axios
                    .post("/sepaktakrawschedule", {
    ...
    const handleClear = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                localStorage.removeItem("sepaktakrawSchedule");
        ...
        <AuthenticatedLayout>
            <div className="container mx-auto mt-8">
                ...
                <div className="flex justify-center gap-4 mb-6">
                    ...
                    <a
                        href={route("sepaktakrawteams.index")}
...
export default SepakTakrawSchedule;
