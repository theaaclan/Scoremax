...
return new class extends Migration
{
    ...
    {
        Schema::create('sepaktakrawplayers', function (Blueprint $table) {
            ...
            $table->foreign('TeamID')->references('TeamID')->on('sepaktakrawteams')->cascadeOnDelete(); // Cascade on delete
...
$table->foreign('LeagueID')->references('LeagueID')->on('leagues')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('sepaktakrawplayers');
    }
};
