...
return new class extends Migration
{
    ...
    {
        Schema::create('volleyballplayers', function (Blueprint $table) {
            ...
            $table->foreign('TeamID')->references('TeamID')->on('volleyballteams')->cascadeOnDelete(); // Cascade on delete
...
$table->foreign('LeagueID')->references('LeagueID')->on('leagues')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('volleyballplayers');
    }
};
