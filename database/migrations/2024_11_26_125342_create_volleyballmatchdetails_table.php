...
return new class extends Migration
{
    ...
    {
        Schema::create('volleyballmatchdetails', function (Blueprint $table) {
...
$table->foreign('LeagueID')->references('LeagueID')->on('leagues')->cascadeOnDelete();
            ...
            $table->foreign('TeamID')->references('TeamID')->on('volleyballteams')->cascadeOnDelete();
            $table->foreign('PlayerID')->references('PlayerID')->on('volleyballplayers')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('volleyballmatchdetails');
    }
};
